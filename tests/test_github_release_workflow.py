...
class GithubReleaseWorkflowTests(unittest.TestCase):
    ...
    def test_release_runtime_bootstrap_uses_official_github_api_and_digest(self) -> None:
        ...
        self.assertIn("autobuild-2026-05-31-15-28", source)
        self.assertIn("ffmpeg-N-124716-g054dffd133-win64-gpl.zip", source)
        self.assertIn("b368f2dd90d460f9a0836dd6faacf9d084a603d99d60ac01cc8d6ff69308cac0", source)
