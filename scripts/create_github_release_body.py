...
| 安装版 / Installer | **[下载安装包 ZIP / Download installer ZIP]({installer_url})** | 解压后运行 `HuifaMediaDownloader-Setup.exe`，在向导中选择安装目录，并可从 Windows“已安装的应用”卸载 / Extract and run the setup wizard; choose the install folder, then uninstall from Windows Installed apps |
